...
public static class Logging
{
    ...
    // Logs go to: C:\Users\<user>\AppData\Local\Temp\howmessy.*.log
    // We're using one log file for each process to prevent concurrent file access.
    private static readonly string vsLogFile = $"{Path.GetTempPath()}/howmessy.vs.log";
    private static readonly string clLogFile = $"{Path.GetTempPath()}/howmessy.codelens.log";
